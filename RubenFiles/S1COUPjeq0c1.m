...
function COUP011
% 3x3 coupled shcroedinger equation. Autor: Ruben Oncala
% Marletta's testexample for the SL12F code.
disp('**************************************************')
disp('Hybrid-Quarkonium meson states COUP011:')
...
t=cputime;
[EigvData,meshData]=computeEigenvalues(system,0,11,5e-8);
...
trapz (x,Y0(1,:,1))
disp(100*(trapz (x,Y0(1,:,1))^2+trapz (x,Y0(2,:,1))^2)/(trapz (x,Y0(1,:,1))^2+trapz (x,Y0(2,:,1))^2+trapz (x,Y0(3,:,1))^2));
disp(100*(trapz (x,Y1(1,:,1))^2+trapz (x,Y1(2,:,1))^2)/(trapz (x,Y1(1,:,1))^2+trapz (x,Y1(2,:,1))^2+trapz (x,Y1(3,:,1))^2));
disp(100*(trapz (x,Y2(1,:,1))^2+trapz (x,Y2(2,:,1))^2)/(trapz (x,Y2(1,:,1))^2+trapz (x,Y2(2,:,1))^2+trapz (x,Y2(3,:,1))^2));
disp(100*(trapz (x,Y3(1,:,1))^2+trapz (x,Y3(2,:,1))^2)/(trapz (x,Y3(1,:,1))^2+trapz (x,Y3(2,:,1))^2+trapz (x,Y3(3,:,1))^2));
disp(100*(trapz (x,Y4(1,:,1))^2+trapz (x,Y4(2,:,1))^2)/(trapz (x,Y4(1,:,1))^2+trapz (x,Y4(2,:,1))^2+trapz (x,Y4(3,:,1))^2));
disp(100*(trapz (x,Y5(1,:,1))^2+trapz (x,Y5(2,:,1))^2)/(trapz (x,Y5(1,:,1))^2+trapz (x,Y5(2,:,1))^2+trapz (x,Y5(3,:,1))^2));
disp(100*(trapz (x,Y6(1,:,1))^2+trapz (x,Y6(2,:,1))^2)/(trapz (x,Y6(1,:,1))^2+trapz (x,Y6(2,:,1))^2+trapz (x,Y6(3,:,1))^2));
disp(100*(trapz (x,Y7(1,:,1))^2+trapz (x,Y7(2,:,1))^2)/(trapz (x,Y7(1,:,1))^2+trapz (x,Y7(2,:,1))^2+trapz (x,Y7(3,:,1))^2));
disp(100*(trapz (x,Y8(1,:,1))^2+trapz (x,Y8(2,:,1))^2)/(trapz (x,Y8(1,:,1))^2+trapz (x,Y8(2,:,1))^2+trapz (x,Y8(3,:,1))^2));
disp(100*(trapz (x,Y9(1,:,1))^2+trapz (x,Y9(2,:,1))^2)/(trapz (x,Y9(1,:,1))^2+trapz (x,Y9(2,:,1))^2+trapz (x,Y9(3,:,1))^2));
disp(100*(trapz (x,Y10(1,:,1))^2+trapz (x,Y10(2,:,1))^2)/(trapz (x,Y10(1,:,1))^2+trapz (x,Y10(2,:,1))^2+trapz (x,Y10(3,:,1))^2));
disp(100*(trapz (x,Y11(1,:,1))^2+trapz (x,Y11(2,:,1))^2)/(trapz (x,Y11(1,:,1))^2+trapz (x,Y11(2,:,1))^2+trapz (x,Y11(3,:,1))^2));
...
[j]=parameters1;
  ...
  r(1,3,i)=2*eta(j)*Vps(x(i))+2*gamma(j)*Vqs(x(i));
  r(3,1,i)=r(1,3,i);


  r(2,3,i)=2*delta(j)*Vqs(x(i));
  r(3,2,i)=r(2,3,i);
