...
disp(100*(trapz (x,Y0(1,:,1))^2+trapz (x,Y0(2,:,1))^2)/(trapz (x,Y0(1,:,1))^2+trapz (x,Y0(2,:,1))^2+trapz (x,Y0(3,:,1))^2+trapz (x,Y0(4,:,1))^2))
disp(100*(trapz (x,Y1(1,:,1))^2+trapz (x,Y1(2,:,1))^2)/(trapz (x,Y1(1,:,1))^2+trapz (x,Y1(2,:,1))^2+trapz (x,Y1(3,:,1))^2+trapz (x,Y1(4,:,1))^2))
disp(100*(trapz (x,Y2(1,:,1))^2+trapz (x,Y2(2,:,1))^2)/(trapz (x,Y2(1,:,1))^2+trapz (x,Y2(2,:,1))^2+trapz (x,Y2(3,:,1))^2+trapz (x,Y2(4,:,1))^2))
disp(100*(trapz (x,Y3(1,:,1))^2+trapz (x,Y3(2,:,1))^2)/(trapz (x,Y3(1,:,1))^2+trapz (x,Y3(2,:,1))^2+trapz (x,Y3(3,:,1))^2+trapz (x,Y3(4,:,1))^2))
disp(100*(trapz (x,Y4(1,:,1))^2+trapz (x,Y4(2,:,1))^2)/(trapz (x,Y4(1,:,1))^2+trapz (x,Y4(2,:,1))^2+trapz (x,Y4(3,:,1))^2+trapz (x,Y4(4,:,1))^2))
disp(100*(trapz (x,Y5(1,:,1))^2+trapz (x,Y5(2,:,1))^2)/(trapz (x,Y5(1,:,1))^2+trapz (x,Y5(2,:,1))^2+trapz (x,Y5(3,:,1))^2+trapz (x,Y5(4,:,1))^2))
disp(100*(trapz (x,Y6(1,:,1))^2+trapz (x,Y6(2,:,1))^2)/(trapz (x,Y6(1,:,1))^2+trapz (x,Y6(2,:,1))^2+trapz (x,Y6(3,:,1))^2+trapz (x,Y6(4,:,1))^2))
disp(100*(trapz (x,Y7(1,:,1))^2+trapz (x,Y7(2,:,1))^2)/(trapz (x,Y7(1,:,1))^2+trapz (x,Y7(2,:,1))^2+trapz (x,Y7(3,:,1))^2+trapz (x,Y7(4,:,1))^2))
disp(100*(trapz (x,Y8(1,:,1))^2+trapz (x,Y8(2,:,1))^2)/(trapz (x,Y8(1,:,1))^2+trapz (x,Y8(2,:,1))^2+trapz (x,Y8(3,:,1))^2+trapz (x,Y8(4,:,1))^2))
disp(100*(trapz (x,Y9(1,:,1))^2+trapz (x,Y9(2,:,1))^2)/(trapz (x,Y9(1,:,1))^2+trapz (x,Y9(2,:,1))^2+trapz (x,Y9(3,:,1))^2+trapz (x,Y9(4,:,1))^2))
disp(100*(trapz (x,Y10(1,:,1))^2+trapz (x,Y10(2,:,1))^2)/(trapz (x,Y10(1,:,1))^2+trapz (x,Y10(2,:,1))^2+trapz (x,Y10(3,:,1))^2+trapz (x,Y10(4,:,1))^2))
disp(100*(trapz (x,Y11(1,:,1))^2+trapz (x,Y11(2,:,1))^2)/(trapz (x,Y11(1,:,1))^2+trapz (x,Y11(2,:,1))^2+trapz (x,Y11(3,:,1))^2+trapz (x,Y11(4,:,1))^2))
disp(100*(trapz (x,Y12(1,:,1))^2+trapz (x,Y12(2,:,1))^2)/(trapz (x,Y12(1,:,1))^2+trapz (x,Y12(2,:,1))^2+trapz (x,Y12(3,:,1))^2+trapz (x,Y12(4,:,1))^2))
disp(100*(trapz (x,Y13(1,:,1))^2+trapz (x,Y13(2,:,1))^2)/(trapz (x,Y13(1,:,1))^2+trapz (x,Y13(2,:,1))^2+trapz (x,Y13(3,:,1))^2+trapz (x,Y13(4,:,1))^2))
disp(100*(trapz (x,Y14(1,:,1))^2+trapz (x,Y14(2,:,1))^2)/(trapz (x,Y14(1,:,1))^2+trapz (x,Y14(2,:,1))^2+trapz (x,Y14(3,:,1))^2+trapz (x,Y14(4,:,1))^2))
disp(100*(trapz (x,Y15(1,:,1))^2+trapz (x,Y15(2,:,1))^2)/(trapz (x,Y15(1,:,1))^2+trapz (x,Y15(2,:,1))^2+trapz (x,Y15(3,:,1))^2+trapz (x,Y15(4,:,1))^2))
...
title(E)
legend('P_0^-(r)','P_0^+(r)','S_1^-(r)','S_1^+(r)')
...
[j]=parameters1;
  ...
  r(1,2,i)=B(x(i),j);
  r(2,1,i)=r(1,2,i);
  r(1,3,i)=2*aap(j)*Vqs(x(i))+2*Vps(x(i));
  r(3,1,i)=r(1,3,i);
  r(1,4,i)=2*bb(j)*Vqs(x(i));
  r(4,1,i)=r(1,4,i);

  r(2,3,i)=2*bb(j)*Vqs(x(i));
  r(3,2,i)=r(2,3,i);
  r(2,4,i)=2*aa(j)*Vqs(x(i))+2*Vps(x(i));
  r(4,2,i)=r(2,4,i);
